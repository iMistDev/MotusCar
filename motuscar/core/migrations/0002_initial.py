    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vehiculos', to='core.usuariocomun')),
            ],
            options={
                'db_table': 'vehiculo',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion', models.CharField(max_length=200)),
                ('telefono', models.CharField(blank=True, max_length=20)),
                ('proveedor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sucursales', to='core.proveedor')),
            ],
        ),
        migrations.CreateModel(
            name='Servicio',
        ...
        migrations.AddField(
            ...
            name='producto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inventario', to='core.products'),
        ),
        migrations.AddField(
            model_name='inventario',
            name='sucursal',
        ...
        migrations.AddField(
            model_name='agenda',
            name='usuariocomun',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.usuariocomun'),
        ),
        migrations.AddField(
            model_name='agenda',
            name='vehiculo',
